:: Launcher made by Me, original lvm mod clone by: MacPlayzYT.

title Vyond Remastered Offline v1 Starting to Launcing (Launching...)
...
:: Open Wrapper in preferred browser
	...
	start chrome.exe --user-data-dir=the_profile --app=https://vyond-remastered-1-2-0.herokuapp.com/html/list.html
	popd
